...
export default function FeaturesPage() {
    return (
        <main className="min-h-screen bg-black selection:bg-secondary/30 relative overflow-x-hidden">
            {/* Background */}
            ...
            <div className="relative z-10 container mx-auto px-4 pt-32 pb-20">
                ...
                <div className="max-w-6xl mx-auto space-y-6 mb-12">
                    ...
                    >
                        xEmployee: The Supersonic Tsunami That Replaces Humans
                    </motion.h1>
                ...
                >
                    <p className="text-secondary font-mono text-xs uppercase tracking-wider mb-3">User Story (Real, happening right now)</p>
                    <h3 className="font-serif text-2xl md:text-3xl text-white mb-2">
                        xEmployee #003 is applying to the Thiel Fellowship 24/7.
                    </h3>
                    <p className="text-white/60 text-sm mb-4">
                        200+ submissions so far.
                    </p>
                    <p className="text-white/60 text-sm mb-4">
                        Waiting for the interview email.
                    </p>
                    <p className="text-white/60 text-sm mb-4">
                        When it lands, this box updates automatically.
                    </p>
                    <div className="flex items-center gap-4 flex-wrap">
                        <a href="#" className="text-secondary hover:text-secondary/80 font-medium text-sm flex items-center gap-2 group">
                            Watch live
                            <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </a>
                        <div className="text-white/40 font-mono text-xs">
                            Applications submitted: <span className="text-secondary font-bold">214</span>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-lg text-white/60 leading-relaxed max-w-md">
                            xEmployee agents crush workflows. Infinite stamina. Zero downtime.
                        </p>
                        <div className="pt-4">
                ...
                >
                    ...
                    <div className="order-1 lg:order-2 space-y-8">
                        ...
                        <p className="text-lg text-white/60 leading-relaxed max-w-md">
                            Like Tesla FSD, but for your business empire.
                        </p>
                        <div className="pt-4">
                            <a href="#" className="text-secondary hover:text-secondary/80 font-medium flex items-center gap-2 group">
                ...
                >
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-8 space-y-4 hover:bg-white/10 transition-colors group">
                        ...
                        <p className="text-white/60 leading-relaxed text-sm">
                            1,000 agents replace 1,000 employees. Overnight.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-8 space-y-4 hover:bg-white/10 transition-colors group">
                        ...
                        <p className="text-white/60 leading-relaxed text-sm">
                            No Breaks. No Burnout. Just Wins.
                        </p>
                    </div>
